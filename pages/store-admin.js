...
export default function AddStoreAdmin() {
    ...
    const getApprovedStores = async () => {
        ...
        try {
            const res = await fetch("https://api.zuget.com/admin/approved-stores", requestOptions);
    ...
    const getStores = async () => {
        ...
        try {
            const res = await fetch("https://api.zuget.com/admin/get-store-admins", requestOptions);
            const result = await res.json();
    ...
    const handleSubmit = async () => {
        ...
        if (confirmResult.isConfirmed) {
            try {
                ...
                const res = await fetch("https://api.zuget.com/admin/add-store-admin", requestOptions);
                const result = await res.json();
    ...
    const handleDeleteAdmin = async (id, name) => {
        ...
        if (confirmDelete.isConfirmed) {
            try {
                ...
                const res = await fetch(`https://api.zuget.com/admin/delete-store-admin?app_user_id=${id}`, requestOptions);
                if (res.ok) {
