...
const ComponentName = (props) => {
  ...
  useEffect(() => {
    async function uploadImg(params) {
      ...
      formdata.append("file", fileInput.files[0], "/C:/Users/Longdrivecars/Downloads/11779115.webp");
      ...
      fetch("https://ecommstagingapis.tboo.com/s3/image-file", requestOptions)
        .then((response) => response.text())
        .then((result) => console.log(result,'s3 working'))
        ...
        <div className="">
          ...
          <div className="flex flex-col gap-y-5 pt-8">
            ...
            <div className="flex gap-x-6">
              <button className="absolute "><input type="file" className="p-2 border rounded-md bg-white text-black"></input></button>
              <Image
                src={
                  assignDoc?.results?.store_image
                }
            ...
            <div className="flex gap-x-2">
              <Image
                src={
                  assignDoc?.results?.store_top_image_1
                }
                alt="line"
                width={500}
                height={300}
              ...
              <Image
                src={
                  assignDoc?.results?.store_top_image_2
                }
                alt="line"
                width={500}
                height={300}
              ...
              <Image
                src={
                  assignDoc?.results?.store_top_image_3
                }
                alt="line"
                width={500}
                height={300}
              ...
              <Image
                src={
                  assignDoc?.results?.store_top_image_4
                }
                alt="line"
                width={500}
                height={300}
