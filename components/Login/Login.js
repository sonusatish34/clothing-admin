    ...
    try {
      ...
      if (role !== "approval") {
        window.localStorage.setItem(
          "user_role_id",
          data?.data?.app_user_data?.role_id
        );
        window.localStorage.setItem(
          "app_user_id",
          data?.data?.app_user_data?._id
        );
      } else {
        window.localStorage.setItem(
          "user_role_id",
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center">
          ...
          {!otpSuccess && (
            <form
              ...
              className="flex flex-col lg:gap-y-7 gap-y-4 justify-center items-left  bg-white xl:h-[500px] xl:w-[500px] h-[200px] w-[2
            ...
            >
              <p className=" font-bold xl:text-2xl lg:text-xl text-lg">
                {" "}
                {role == "approval" && <span className=""> Approval Team</span>}
              </p>
          ...
          {otpSuccess && (
            <div className="flex flex-col mxs lg:gap-y-3 gap-y-1 justify-center items-left bg-white  xl:h-[500px] xl:w-[500px] h-[200px] w-[250px] lg:h-[400px] lg:w-[400px] lg:px-14 lg:p-6 px-2 rounded-r-md shadow-lg">
              ...
              <div>
                <button
                  onClick={() => {
                    ...
                    if (otp.join("").length === 4) {
                      // validateOtp();
                      // console.log("yes 4");
                      localStorage.setItem("user_phone", "7989030741");
                ...
                <p className="flex justify-between pt-3 text-xs">
                  <span
                    onClick={() => {
                      setOtpSuccess(false);
                    }}
